...
class OpenIdSessionTest extends TestCase {
    ...
    public function testLoginUrlForMultipleScopes() {
        ...
        $this->assertEquals(
            ...
            OpenIdSession::getAuthorizationUrl($redirectUri, $scope, $clientId),
    ...
    public function testLoginWithCustomConfig() {
        ...
        $this->assertEquals(
            ...
            OpenIdSession::getAuthorizationUrl($redirectUri, $scope, "DummyId", null, null, $this->context),
    ...
    public function testLogoutWithCustomConfig() {
        ...
        $this->assertEquals(
            ...
            OpenIdSession::getLogoutUrl($redirectUri, $idToken, $this->context),
            "Failed case - custom config"
        );
    }
}
